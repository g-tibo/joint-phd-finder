...
class Faculty(TypedDict):
    ...
    institution: str                           # short code: "NTU", "Sorbonne", "TUM", "Turin"
    partner_university: NotRequired[str]       # NTU for NTU staff; partner short-code otherwise
    partnership_type: NotRequired[str | None]  # "Degree" | "Supervision" | None
