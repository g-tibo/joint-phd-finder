...
# Department slug -> full display name. Order matches the main YLL "Departments"
# menu on medicine.nus.edu.sg.
DEPARTMENTS: list[tuple[str, str]] = [
    ...
    ("meddnr", "Department of Diagnostic Radiology"),
    ("medi", "Department of Medicine"),
    ("mbio", "Department of Microbiology and Immunology"),
    ("obgyn", "Department of Obstetrics and Gynaecology"),
    ("medoph", "Department of Ophthalmology"),
    ("os", "Department of Orthopaedic Surgery"),
    ("ent", "Department of Otolaryngology"),
    ("paed", "Department of Paediatrics"),
    ("patho", "Department of Pathology"),
    ("medphc", "Department of Pharmacology"),
    ("phys", "Department of Physiology"),
    ("pcm", "Department of Psychological Medicine"),
    ("medsur", "Department of Surgery"),
]
